...
public class FloatingModMenuService extends Service {
	...
	int TEXT_COLOR_4 = Color.parseColor("#202020");
    ...
    int BtnON = Color.parseColor("#00BCD4");
    int BtnOFF = Color.parseColor("#9E9E9E");
    int CategoryBG = Color.parseColor("#006771");
    ...
    private void initFloating() {
        ...
        gdMenuBody.setStroke(5, Color.CYAN); //Set border
        ...
        gdMenuBody.setColor(this.TEXT_COLOR_4);
        gdMenuBody.setCornerRadii(new float[]{0, 0, 0, 0, 0, 0, 0, 0});
        gdMenuBody.setStroke(4, Color.CYAN);
                ...
                btndialog.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (numOnly) {
                            ...
                            button.setText(Html.fromHtml(featName + ": <font color='#00BCD4'>" + num + "</font>"));
                            alert.dismiss();
                            Preferences.changeFeatureInt(featName, feature, num);
                        } else {
                            String str = edittext.getText().toString();
                            edittextstring.setString(edittext.getText().toString());
                            button.setText(Html.fromHtml(featName + ": <font color='#00BCD4'>" + str + "</font>"));
                            alert.dismiss();
